...
fun DinosaurPhotoApp() {
    ...
    Scaffold(
        ...
        Surface(
            ...
            val dinosaurViewModel: DinosaurViewModel = viewModel()
            HomeScreen(
                dinosaurUiState = dinosaurViewModel.dinosaursUiState, retryAction = dinosaurViewModel::getDinosaurPhotos)
        }
    }
}
